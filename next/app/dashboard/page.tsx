...
<a className="w-full flex items-center justify-between px-3 py-2 rounded bg-white/[0.03] hover:bg-white/[0.06] border border-white/[0.07] text-zinc-300 hover:text-white transition-colors text-[11px] font-mono" href="/dashboard">

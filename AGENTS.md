...
- **Read Core Documentation First**: Before proposing or executing any code, you MUST read this file (`AGENTS.md`), `ROADMAP.md`, `CONTRIBUTING.md`, and `docs/architecture.md`.
...
- **Update the Roadmap**: After completing a feature or task, you MUST update the `ROADMAP.md` file to reflect the new status.
